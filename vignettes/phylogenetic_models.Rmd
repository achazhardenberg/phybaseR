...
The core strength of phybaseR is combining structural equation modeling with phylogenetic comparative methods. This accounts for the non-independence of species data due to shared evolutionary history.
...
phybaseR uses the phylogenetic VCV matrix to model evolutionary correlations:
...
Not currently implemented in phybaseR, but you can:
...
phybaseR's `tree` argument accepts **any covariance structure**, not just phylogenies! You can model:
...
- **[Getting Started](getting_started.html)** - Basic usage
- **[Advanced Models](advanced_models.html)** - Random effects and polynomials
- **[Model Diagnostics](model_diagnostics.html)** - Interpreting results
- **[Latent Variables](latent_variables.html)** - Measurement models
