...
vignette: >
  %\VignetteIndexEntry{Alternative Covariance Structures}
...
- **[Phylogenetic Models](phylogenetic_models.html)** - Special case of covariance structure
- **[Advanced Models](advanced_models.html)** - Random effects  
- **[Getting Started](getting_started.html)** - Basic usage
- **[Model Diagnostics](model_diagnostics.html)** - Model checking
