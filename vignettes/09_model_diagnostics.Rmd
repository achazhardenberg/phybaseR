...
vignette: >
  %\VignetteIndexEntry{Model Diagnostics and Interpretation}
...
fit <- because(equations, data, dsep = TRUE)
...
See **[Latent Variables](08_latent_variables.html)** vignette for details.
...
```{r, eval=FALSE}
fit1 <- because(equations1, data, DIC = TRUE)
fit2 <- because(equations2, data, DIC = TRUE)
...
- **[Getting Started](01_getting_started.html)** - Basic workflow
- **[Phylogenetic Models](03_phylogenetic_models.html)** - Tree-based models  
- **[Advanced Models](06_advanced_models.html)** - Complex specifications
- **[Latent Variables](08_latent_variables.html)** - M-separation
