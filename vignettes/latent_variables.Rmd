...
vignette: >
  %\VignetteIndexEntry{Latent Variables and MAG}
...
Latent variables represent unobserved constructs that cannot be directly measured. phybaseR uses Maximal Ancestral Graphs (MAGs) for m-separation testing when latent variables are present.
...
3. **Induced correlations**: phybaseR models correlations induced by latent variables
...
phybaseR handles both naturally through equation specification.
...
phybaseR models this induced correlation in the JAGS model.
...
- **[Phylogenetic Models](phylogenetic_models.html)** - Combining phylogeny with latents  
- **[Model Diagnostics](model_diagnostics.html)** - Convergence and interpretation
