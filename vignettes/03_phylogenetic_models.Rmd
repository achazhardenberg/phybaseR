...
In cases where there is uncertainty about the phylogenetic relationships among species, `because` allows users to fit models across a sample of trees as described in von Hardenberg and Gonzalez Voyer, 2025). You just need to provide a list of phylogenetic trees (class `multiPhylo`) to the `structure` argument instead of a single tree. 
