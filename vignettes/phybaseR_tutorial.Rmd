...
**When to use explicit**: If you have:
- Strong theoretical priors on latent variable scales
- Additional constraints (e.g., fixing one path to 1, "marker variable" approach)
- Need to report specific latent -> observed effects (acknowledging identification constraints)
...
- **Bollen, K. A. (1989).** *Structural Equations with Latent Variables*. Wiley. (Classic treatment of identification in SEM)
- **Pearl, J. (2009).** *Causality: Models, Reasoning, and Inference* (2nd ed.). Cambridge University Press. (Chapter on MAGs and latent variables)
- **Richardson, T., & Spirtes, P. (2002).** Ancestral graph Markov models. *Annals of Statistics*, 30(4), 962-1030. (Formal theory of MAGs)
- **Shipley, B. (2016).** *Cause and Correlation in Biology* (2nd ed.). Cambridge University Press. (d-separation and causal inference in phylogenetics)
