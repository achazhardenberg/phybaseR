...
# Simulate IUCN-like conservation status (1=LC, 2=NT, 3=VU, 4=EN, 5=CR)
# Larger body mass -> lower threat
eta <- -0.8 * log(abs(X) + 1) # Linear predictor
...
# Simulate count data (e.g., species richness)
# Larger area -> more species
log_area <- rnorm(N)
log_richness <- 2 + 0.5 * log_area # log(E[Y])
