...
vignette: >
  %\VignetteIndexEntry{05. Non-Gaussian Distributions}
...
phybaseR supports multiple response distributions to match different data types. Choose the distribution that matches your response variable's characteristics.
...
phybaseR uses standard links automatically. Custom links are not currently supported.
...
- **[Advanced Models](advanced_models.html)** - Random effects, polynomials
- **[Model Diagnostics](model_diagnostics.html)** - Convergence and model comparison
- **[Phylogenetic Models](phylogenetic_models.html)** - Works with all distributions!
