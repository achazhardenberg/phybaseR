...
f1 <- y ~ x + I(x^2)
poly1 <- becauseR:::extract_polynomial_terms(f1)
print(poly1)
cat("\n")
...
f2 <- y ~ x + I(x^2) + I(x^3)
poly2 <- becauseR:::extract_polynomial_terms(f2)
print(poly2)
cat("\n")
...
poly3 <- becauseR:::extract_polynomial_terms(f3)
print(poly3)
cat("\n")
...
f4 <- y ~ x + I(x^2) + I(x^3)
poly4 <- becauseR:::extract_polynomial_terms(f4)
expanded <- becauseR:::expand_polynomial_formula(f4, poly4)
...
jags_code <- becauseR:::generate_polynomial_jags(poly4)
...
f5 <- y ~ x + z
poly5 <- becauseR:::extract_polynomial_terms(f5)
print(poly5)
cat("\n")
