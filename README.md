...
**phybaseR** provides a unified framework for specifying and fitting Bayesian structural equation models using [JAGS](http://mcmc-jags.sourceforge.net).
...
-   **Generalized Covariance Structures**: Supports standard SEMs, Phylogenetic SEMS (PhyBaSE)  Spatial SEMs, and Animal Models via custom covariance matrices or pedigrees.
...
```r
vignette("01_getting_started", package = "phybaseR")
```


## Citation

If you use **phybaseR** in your research, please cite:
